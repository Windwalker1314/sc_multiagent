...
def plt_win_rate_mean():
    ...
    plt.plot(range(len(win_rates[0])), win_rates[0], c='r', label='qmix',linewidth='3')
    plt.plot(range(len(win_rates[1])), win_rates[1], c='g', label='ddn',linewidth='3')
    plt.plot(range(len(win_rates[2])), win_rates[2], c='b', label='dtrans',linewidth='3')
